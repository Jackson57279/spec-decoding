...
- Next priorities: Add typed metadata-only loaded target/draft placeholders behind the loader shell, then replace the placeholders with real Candle/GGUF inference once dependencies are selected.
