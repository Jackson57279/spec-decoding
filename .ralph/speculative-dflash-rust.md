...
- Next priorities: Add a tiny dependency-free tokenizer placeholder from parsed tokenizer metadata, then replace metadata placeholders with real tokenizer/model implementations once adapter dependencies are selected.
